...
<body>
	...
	<div class="wrapper">
		<div class="sidebar">
			<h2>ADMIN</h2>
			<ul>
				<li><a href="ModificaMia"><i
						class="fas fa-trash-alt"> Elimina</i></a></li>
		...
		<div class="main_content">
				<div class="header"
					...
					<h2 style="outline: none; border: none; background-color: rgba(255, 255, 255, 0.05);">INSERIMENTO MOTO</h2>
				</div>
			<div class="info">
			...
			<fieldset>
				...
				<br><label style="display: inline-block; vertical-align: baseline; width: 125px;" for="accessori">Accessori:</label>
				<input type="text" name="accessori" value="<%=cl.getAccessori() %>">
				
				<br><label style="display: inline-block; vertical-align: baseline; width: 125px;" for="custom">Custom:</label>
				<input type="text" name="custom" value="<%=cl.getCustom() %>">
