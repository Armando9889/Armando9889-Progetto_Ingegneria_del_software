...
import java.net.URL;
public class EliminaVeicoloSeleniumTest {
  ...
  public void tC56() {
    ...
    driver.findElement(By.linkText("Elimina")).click();
    driver.findElement(By.cssSelector("tbody:nth-child(16) td > input")).click();
